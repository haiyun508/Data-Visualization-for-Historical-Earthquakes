...
d3.csv("static/data/cleanedEarthquakes.csv").then((importedData) => {
    ...
    function updateMap(filteredData) {
        ...
        for (var i = 0; i < filteredData.length; i++) {
            ...
            "</h6><hr> <h6>Depth: "+filteredData[i].Depth+"<h6>"));

        }
        var markers = L.layerGroup(circleMarkers)
        markers.addTo(myMap)
...
// https://earthquake.usgs.gov/earthquakes/eventpage/usp00000kc/waveforms